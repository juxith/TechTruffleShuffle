namespace TechTruffleShuffle.Data.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<TechTruffleShuffle.Data.TechTruffleShuffleEntities>
    {
        ...
        protected override void Seed(TechTruffleShuffle.Data.TechTruffleShuffleEntities context)
        {
            ...
            //BlogPost workingPost1 = context.BlogPost.Include( p => p.Hashtags).Single(p => p.Title == "JavaScriptMn, Monthly Meet Up");
            ...
            //BlogPost workingPost2 = context.BlogPost.Include(p => p.Hashtags).Single(p => p.Title == "Hack-o-Thon");
            ...
            //BlogPost workingPost3 = context.BlogPost.Include(p => p.Hashtags).Single(p => p.Title == "Grace Hopper Viewing party");
            ...
            //BlogPost workingPost4 = context.BlogPost.Include(p => p.Hashtags).Single(p => p.Title == "Grace Hopper Viewing party");
            ...
            //BlogPost workingPost5 = context.BlogPost.Include(p => p.Hashtags).Single(p => p.Title == "People who Truffle Shuffles");
